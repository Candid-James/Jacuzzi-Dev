      ...
      .then((html) => {
        ...
        if (fetchedElement) {
          ...
          if (appendItem) {
            ...
            featureItemSlider();
            $.getScript(
              'https://cdn.jsdelivr.net/npm/@candid-james-battye/jacuzzi-dev@1.2.40/dist/showPricingForm.js'
            );
            $.getScript(
              'https://cdn.jsdelivr.net/npm/@candid-james-battye/jacuzzi-dev@1.2.25/dist/showPricing.js'
            );
